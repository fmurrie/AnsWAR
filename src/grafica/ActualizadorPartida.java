...
public class ActualizadorPartida extends Thread
{
	...
	public ActualizadorPartida(JTextField textFieldPuntaje,JTextField txtPreguntasAcertadas,SuperPanel obj,JTextField textFieldTiempo)
	{
	...
	public void run()
	{
		while(textFieldTiempo.getText().equalsIgnoreCase("00:00:00")==false)
		{
			...
			txtPreguntasAcertadas.setText("Preguntas acertadas: " + ((ContenidoPartida)obj).getPreguntasAcertadasDePartida());
		}
